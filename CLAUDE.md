...
```bash
sonar analyze agentic --project aifred_vulnerable-todo-app --depth DEEP --file <path/to/file1> --file <path/to/file2>
```
...
```bash
sonar analyze agentic --project aifred_vulnerable-todo-app --depth DEEP
```
